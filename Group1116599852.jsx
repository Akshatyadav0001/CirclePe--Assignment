import './Group1116599852.css'

export default function Group1116599852() {
  return (
    <div className="group-1116599852">
      <div className="component-11">
        <img className="ellipse-92" src="assets/vectors/Ellipse925_x2.svg" />
        <div className="rectangle-9">
        </div>
        <div className="screenshot-20240213-at-2171">
        </div>
        <div className="container">
          <img className="group-1" src="assets/vectors/Group19_x2.svg" />
